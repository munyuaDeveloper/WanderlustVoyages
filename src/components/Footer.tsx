        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-4">
              Discover amazing destinations around the world with our curated travel packages.
          ...
          {/* Travel Categories */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-yellow-400">Travel Categories</h3>
            <ul className="space-y-2">
              <li>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start">
                ...
                <p className="text-gray-300">info@wanderlustvoyages.com</p>
              </div>
            </div>
          </div>
        </div>
